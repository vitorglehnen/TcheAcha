          ...
          <View style={styles.statusCardsContainer}>
            ...
            >
              <Text style={styles.cardTitle}>
                Status validação dos documentos
              </Text>
              <View style={styles.statusIconContainer}>
                <Ionicons
                  name={
                    getStatusVerificacaoIcone(userData.status_verificacao).name
                  }
                  size={40}
                  color={
                    getStatusVerificacaoIcone(userData.status_verificacao).color
                  }
                />
              </View>
            ...
            <View style={styles.statusCard}>
              <Text style={styles.cardTitle}>
                Última verificação de localização
              </Text>
              <View style={styles.statusIconContainer}>
              ...
              <Text style={styles.statusText}>
                {userData.ultima_localizacao
                  ? new Date(userData.ultima_localizacao).toLocaleTimeString(
                      "pt-BR",
        ...
        <View style={styles.modalOverlay}>
          <View style={styles.modalContent}>
            ...
            <TextInput
              ...
              placeholder={
                editField === "telefone" ? "+55 51 99999-9999" : "Nome Completo"
              }
