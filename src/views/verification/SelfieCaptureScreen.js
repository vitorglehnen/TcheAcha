...
export default function SelfieCaptureScreen() {
    ...
    async function takeSelfie() {
        ...
        if (status !== 'granted') {
            Alert.alert('Permissão necessária', 'Você precisa autorizar o uso da câmera para continuar.');
            return;
        }
    ...
    function handleContinue() {
        // **AJUSTE**: Navega de volta enviando o novo status da selfie (true)
        // e preservando o status do documento que foi recebido.
        navigation.navigate('VerifyIdentity', { selfieDone: true, docDone: docIsDone });
    }
        ...
        <View style={styles.container}>
            ...
            <View style={styles.content}>
                <Text style={styles.title}>
                    {selfie ? "A sua selfie ficou legal?" : "Centralize seu rosto no círculo e olhe para a câmera"}
                </Text>
                ...
                {selfie ? (
                    <View style={styles.optionsContainer}>
                        ...
                        <TouchableOpacity style={styles.secondaryBtn} onPress={() => setSelfie(null)}>
